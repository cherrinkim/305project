...
<html>
    <head>
        ...
        <title>View Which Customer Generated the Most Revenue</title>
    </head>
    <body>
        <% if (session.getAttribute("ismanager") != null) { %>
        <% if ((Boolean) session.getAttribute("ismanager")) { %>
            <jsp:include page="header.jsp"/>
            <h2>View Which Customer Generated the Most Revenue</h2>
            <%
            String id = "dummy";
            ...
            if (rs.next()) {
                ...
                </br><h2>User #<%=session.getAttribute("queriedid")%> (<%=session.getAttribute("queriedname")%>) has generated the most revenue.</h2>
