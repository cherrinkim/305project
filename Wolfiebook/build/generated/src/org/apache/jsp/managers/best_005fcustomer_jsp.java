...
public final class best_005fcustomer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>View Which Customer Generated the Most Revenue</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        ");
 ...
 if ((Boolean) session.getAttribute("ismanager")) { 
      ...
      out.write("\n");
      out.write("            <h2>View Which Customer Generated the Most Revenue</h2>\n");
      out.write("            ");
            ...
            ResultSet rs;
            rs = st.executeQuery("SELECT S.buyer_id, SUM(S.charge_amount) as 'revenue' "
                    + "FROM Sales S "
                    + "GROUP BY buyer_id "
 ...
 while (rs.next()) { 
      ...
      out.write("            <br />\n");
      out.write("            <br />\n");
      out.write("            <a href=\"revenue_customer.jsp\">Start a new query</a>\n");
      out.write("        ");
 } else { 
      out.write("\n");
