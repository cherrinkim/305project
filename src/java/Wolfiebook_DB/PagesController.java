...
public class PagesController implements Serializable {
    ...
    @EJB
    private Wolfiebook_DB.PagesFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Pages) getItems().getRowData();
    ...
    public static class PagesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pages) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Pages.class.getName());
            }
        }
